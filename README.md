...
4-mode segmented control (Signal exploration · Noise · ML diagnostics · Paper
figures; ADR-027), and dark / light / vibrant themes that persist across
